...
<div class="container-fluid py-5">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-12 align-self-center wow fadeIn" data-wow-delay="0.3s">
                <h1 class="text-center"> BTL con creatividad funcional</h1>
    ...
    <div class="container">
        ...
        <div class="col-lg-4">
        <div class="card">
            <img class="card-img-top img-fluid" src="{{asset('assets/img/btl/btl-1.jpg')}}" alt="Card image">

            <div class="card-body">

              <h4 class="card-title"><a>Retail</a></h4>
...
<div class="container-fluid bg-light mt-5 py-5">
    <div class="container py-5">
        ...
        <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
            <img class="img-fluid" src="{{asset('assets/img/btl/btl-5.jpg')}}" alt="reclutamiento_img">
    </div>
    </div>
</div>
</div>
<div class="container-fluid py-5">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-12 align-self-center wow fadeIn" data-wow-delay="0.3s">
<h2>El street marketing está más vigente que nunca</h2>
<p>
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 align-self-center wow fadeIn" data-wow-delay="0.3s">
                <img class="img-fluid" src="{{asset('assets/img/btl/btl-8.jpg')}}" alt="sta">
            </div>
        </div>
    </div>
</div>
<div class="container-fluid bg-light mt-5 py-5">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-5 align-self-center wow fadeIn" data-wow-delay="0.3s">
                <h1>Servicios adicionales</h1>
            </div>
            <div class="col-lg-4 align-self-center wow fadeIn" data-wow-delay="0.3s">
                <h1 class="mb-5">Diseño y confección de uniformes</h1>
                <h1 class="mb-5">Producción de material POP</h1>
                <h1 class="mb-5">Diseño y producción de stands</h1>
            </div>
            <div class="col-lg-3 align-self-center wow fadeIn" data-wow-delay="0.3s">
                <img class="img-fluid mb-4" src="{{asset('assets/img/btl/btl-9.jpg')}}" alt="star" >
                <img class="img-fluid mb-4" src="{{asset('assets/img/btl/btl-10.jpg')}}" alt="star" >
                <img class="img-fluid mb-4" src="{{asset('assets/img/btl/btl-11.jpg')}}" alt="star" >
            </div>
        </div>
    </div>
</div>
<div class="container-fluid pt-5 fondo1">
    <div class="container">
        <div class="fondo1">
            <div class="col-lg-12 align-self-center wow fadeIn" data-wow-delay="0.3s">
