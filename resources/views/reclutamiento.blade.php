    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-8 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                <h1 class="text-black mb-4">¿Qué es el reclutamiento digital?</h1>
                <p>Es la adaptación de la metodología inbound marketing a procesos de reclutamiento. Aprovecha las herramientas digitales, que proveen las redes sociales, para llegar al público objetivo de una forma más rápida y eficiente.</p>
            </div>
        </div>
    </div>
    <div class="container">
            ...
            <div class="col-lg-5  mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                <h1 class="text-black">
                    ...
                    <h1 class="text-black mb-4">Digital.</h1>
                            ...
                            <p>• Los contratamos más rápido</p>
                            <p>• Sobre todo, somos empáticos durante todo el proceso</p>
                            <p>• Evita costos de gastos fijos en las empresas: telefonía, estaciones de trabajo etc. tampoco tienen que contratar adicionalmente portales de búsqueda, y ahorro en contratación de personal de reclutamiento interno.</p>
        ...
        <div class="container ">
            <div class="row g-5 ">
                <div class="col-lg-12 align-self-center text-center text-lg-start mb-lg-5">
                    <h2 class="mb-4">Proceso Integral
                        </h2>
                        <p >Podemos intervenir en el proceso integral de reclutamiento, hasta la contratación y capacitación</p>
                        <img class="img-fluid" src="{{asset('assets/img/reclutamiento/reclutamiento-1.jpg')}}" alt="reclutamiento_img">
                </div>
            </div>
        </div>
    </div>  
        ...
        <div class="row g-5">
            <div class="col-lg-8 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                ...
                <div class="col-lg-4 align-self-center mb-md-5  wow fadeIn bg-light" data-wow-delay="0.3s">
                    <p class="">
                        El 95% de los candidatos dice que su primera experiencia con una empresa es una visita a la página de empleo.
                        (Bernard Hodes Group).</p>
                </div>
                <div class="col-lg-8 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="col-lg-4 align-self-center mb-md-5  wow fadeIn bg-light" data-wow-delay="0.3s">
                        <p class="">
                            El 79% de los candidatos busca empleo en las redes sociales.
                            (Glassdoor)</p>
                    </div>
                    ...
                    <div class="col-lg-8 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <div class="col-lg-4 align-self-center mb-md-5  wow fadeIn bg-light" data-wow-delay="0.3s">
                            <p class="">
                                El 79% de los candidatos siente frustración al no recibir información después de inscribirse a una oferta.
                                (Potentialpark)</p>
                        </div>
                        <div class="col-lg-8 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div class="col-lg-4 align-self-center mb-md-5  wow fadeIn bg-light" data-wow-delay="0.3s">
                                <p class="">
                                    El 85% de los candidatos están abiertos a un cambio de empleo.
                                    (LinkedIn)</p>
                            </div>
            </div>
