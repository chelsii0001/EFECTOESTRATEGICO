        ...
        <nav class="navbar navbar-expand-lg navbar-dark p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto">
                    ...
                    <a href="{{ route('inbound') }}" class="nav-item nav-link" style="color: #fff">Inbound Marketing</a>
                    <a href="{{ route('reclutamiento') }}" class="nav-item nav-link" style="color: #fff">Reclutamiento Digital</a>
                    <a href="{{ route('call') }}" class="nav-item nav-link" style="color: #fff">Call Center</a>
